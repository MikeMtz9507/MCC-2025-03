...
while id<=3:
    ...
    match(id):
        ...
        case 3:
            ...
            instancia_name= "iris"
        case 4:
            instancia= CargaInstancia.cargarInstancia("../Archivos/iris/iris_estandarizado.csv")
            instancia_name= "iris_estandarizado"
        case 5:
            instancia= CargaInstancia.cargarInstancia("../Archivos/iris/iris_normalizado.csv")
            instancia_name= "iris_normalizado"
